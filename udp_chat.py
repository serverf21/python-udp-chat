...
def client(port):
    ...
    while True:
        ...
        s.send(data)
        data, server_address = s.recvfrom(MAX_SIZE_BYTES)
...
if __name__ == '__main__':
    ...
    parser.add_argument('function', choices=funcs, help='client or server')
    parser.add_argument('-p', metavar='PORT', type=int,
                        default=3000, help='UDP port (default 3000)')
    args = parser.parse_args()
    function = funcs[args.function]
    function(args.p)
